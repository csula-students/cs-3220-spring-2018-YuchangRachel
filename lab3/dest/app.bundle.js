...
exports.default = {
	...
	actions: {
		...
		BUTTON_CLICK: 'MY_AMAZING_BUTTON_CLICK',
...
class Generator {
  ...
  */
	getCost() {
		...
		var cost = parseFloat((this.baseCost * Math.pow(1 + _constants2.default.growthRatio, this.quantity)).toFixed(2));
		return cost;
	}
...
function main() {
	...
	// assign default value at the beginning
	const initialState = {
