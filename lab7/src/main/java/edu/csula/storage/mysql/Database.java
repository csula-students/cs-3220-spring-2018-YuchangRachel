...
public class Database implements edu.csula.storage.Database{
	...
	private static final String database = "cs3220";  //fill my own database name cs3220
	private static final String host = "localhost";    //localhost cs3 also same
	private static final String url = String.format("jdbc:mysql://%s/%s", host, database);
	private static final String username = "root";    //root
	private static final String password = "mypassword";   //fill my own password 
